  ...
  const statsCards = useMemo(
    () => [
      ...
      },
      {
        ...
        meta: `P:${dashboard.pendingJobs || 0} A:${dashboard.approvedJobs || 0} R:${dashboard.rejectedJobs || 0}`,
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        meta: `P:${dashboard.pendingScholarships || 0} A:${dashboard.approvedScholarships || 0} R:${dashboard.rejectedScholarships || 0}`,
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    ...
                    <div key={card.title} className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          {card.meta && (
                            <p className="mt-1 text-xs font-medium text-gray-500 dark:text-gray-400">{card.meta}</p>
                          )}
                        </div>
